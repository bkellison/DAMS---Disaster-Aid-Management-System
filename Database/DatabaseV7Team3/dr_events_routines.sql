...
BEGIN
    ...
    -- 4. Check if fulfilled pledges + responses matches request quantity
	--	SELECT quantity
    --  INTO var_request_quantity
    --  FROM request
...
BEGIN
    ...
    -- 2. Update pledge's allocated_quantity
		UPDATE dr_events.pledge
        SET allocated_quantity = allocated_quantity + param_match_quantity
...
-- Dump completed on 2025-04-22  4:47:54
