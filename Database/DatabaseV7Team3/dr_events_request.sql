...
CREATE TABLE `request` (
  ...
  `details` text,
  `status` enum('pending','approved','fulfilled','canceled','matched') NOT NULL DEFAULT 'pending',
...
INSERT INTO `request` VALUES (1,15,2,3,4,'Medicine','matched','2025-04-22 01:01:33'),(2,15,1,2,1,'test','pending','2025-04-22 01:08:06');
