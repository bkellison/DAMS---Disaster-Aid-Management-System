...
CREATE TABLE `match` (
  ...
  `match_type` enum('manual','auto (nearest)','auto (quickest)','auto (fulfillment)','auto (other)') DEFAULT NULL,
...
INSERT INTO `match` VALUES (28,4,6,'matched',14,'2025-04-27 23:41:23','delivered','2025-04-27','1234567','100 A ave NE','2025-04-28 00:04:55',NULL,0),(29,9,1,'matched',10,'2025-04-28 00:00:47','pending',NULL,NULL,NULL,'2025-04-28 00:00:47',NULL,0);
