...
CREATE TABLE `user` (
  ...
  `role` enum('Admin','Donor','Recipient','Call Center Operator','Admin Observer') NOT NULL,
...
-- Dump completed on 2025-05-23 22:11:07
